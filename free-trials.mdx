...
[ ![](/images/6b08ea4-Group_17013.png)  Pricing table Allow customers to select the plan that that they'd like to subscribe to from your public pricing page ](react-sdk#rendering-pricing-tables) 

  
[ ![](/images/1bf91dd-Group_17013_1.png)  In-app paywall Allow customers to upgrade their subscriptions in a self-served manner using an in-app paywall ](/react-sdk#rendering-pricing-tables) 

  
[ ![](/images/5531b6c-Group_16979.png)  Customer portal Introduce self-service and drive in-app expansions using only a few lines of codes ](/react-sdk#rendering-a-customer-portal) 
