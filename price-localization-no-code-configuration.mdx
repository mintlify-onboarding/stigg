...
Click on the "+ Add country" section.
...
![](/images/9f90eb4-Screenshot_2023-03-30_at_0.09.45.png)
...
When price localization is defined for the plan or add-on, localized prices will appear under their "Price" section:

![](/images/cceaf01-Screenshot_2023-03-29_at_23.55.47.png)
...
When a customer has never subscribed to a paid subscription, in the "Create subscription" screen you may select either the default price or any of the localized prices:

![](/images/30e8e01-Screenshot_2023-03-30_at_0.07.56.png)

When a customer had a previous paid subscription, due to [Stripe's limitation](https://support.stripe.com/questions/setting-a-customers-default-currency), it's only possible to select one of the localized prices for that specific country:

![](/images/9f04b1a-Screenshot_2023-03-30_at_0.05.38.png)
