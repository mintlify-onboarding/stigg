...
We will add the features definitions along with their [fallback](/high-availability-architecture#local-caching-and-fallback-strategy):
...
<Card title="stiggio/stigg-aws-api-gateway-example github.com" href="https://github.com/stiggio/stigg-aws-api-gateway-example" icon="github"></Card>
