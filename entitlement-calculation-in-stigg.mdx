...
1. Active subscription  
   i. Active plan - an entitlement that's defined for the current plan that the customer is subscribed to.  
   ii. Base plan - an entitlement that's inherited from a parent plan of the plan that the customer is subscribed to.  
   iii. Add-ons - due to the fact that add-ons extend plans, when a subscription includes both plans and add-ons that are defined using the same configuration or metered features, the entitlement value for those features would be the **sum** of the entitlements of that specific feature. For example: if a customer has a subscription for a plan, and as part of that plan they’re entitled to X units of a specific feature. If they’ll also purchase an add-on with Y units of the same feature, the customer will be entitled to X + Y units as part of their subscription. Moreover, if the customers pays for a quantity of Q add-ons as part of their subscription, they’ll be entitled to X + Y \* Q units of that feature.
