...
| Management API | Mission-critical APIs                           |                                  | Stack | ELB  Fargate  RDS  SQS  Lambda  Aurora Global Database  Route 53 | CloudFront [\[email protected\]](/cdn-cgi/l/email-protection)  DynamoDB |
| -------------- | ----------------------------------------------- | -------------------------------- | ----- | ---------------------------------------------------------------- | ----------------------------------------------------------------------- |
