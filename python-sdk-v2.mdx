...
This library provides a Python client to interact with [Stigg's GraphQL API ](/graphql-api)based on the operations the [Stigg's Node.js SDK](/nodejs-sdk) is using under the hood.
...
<Warning>
Looking for the older version of the Python client?
 
You can find the docs for the old Python SDK client here: [stigg-api-client](/python-sdk).
</Warning>
