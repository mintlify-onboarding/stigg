...
In the [Stigg Console](%F0%9F%94%97), under the **Settings > Integrations > Apps** section, select the HubSpot connector.
...
In the [Stigg Console](%F0%9F%94%97), entities that are synced from Stigg to HubSpot have a clickable "CRM ID" property with a HubSpot logo next to it and indication of their sync status (successful, failed, [will not be synced](#entities-that-are-not-synced-to-hubspot)).
...
In the [Stigg Console](%F0%9F%94%97), clicking on the link of the "CRM ID" property will open the relevant entity in HubSpot.
...
To remove the integration, in the [Stigg Console](%F0%9F%94%97), under the **Settings > Integrations > Apps** section, select the HubSpot connector.
...
> ### 📘
> 
> If any of the above mentioned limitations affect your use-case, [let us know](/cdn-cgi/l/email-protection#63101613130c11172310170a04044d0a0c) and we'd be happy to work together to lift them.
